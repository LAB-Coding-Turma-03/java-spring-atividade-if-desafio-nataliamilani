...
public class SimularValoresControllerTests {
	...
	public void ShouldCalculateTocaAndCodTipoPagamento1Test() throws Exception {
		...
		assertEquals("Touca sendo pago A vista no dinheiro com 10% de desconto custará 31,50 reais".toUpperCase(), response.toUpperCase());
	...
	public void ShouldCalculateLuvasAndCodTipoPagamento3Test() throws Exception {
		...
		assertEquals("Luvas sendo pago Em duas parcelas sem nenhum desconto custará 19,50 reais".toUpperCase(), response.toUpperCase());
